...
package com.dangries.display {
	...
	public class RotatingParticleBoard extends Bitmap {
		...
		private function getDepthColour( depth:Number ):uint
		{
			//trace( 'getDepthColour :: depth =' + depth );
			
			var _depth = Math.max( 0, Math.min( depth, 255 ) );
			var _index:uint = Math.floor( _depth * ( _depthMap.length / 2 ) );
			
			//trace( 'getDepthColour :: _index =' + _index );
			
			return _depthMap[ _index ];
		}
		
		private function getDepthMap():Array
		{
			var _colours:Array = [0xfffefdde, 0xfffefec7, 0xfffdfeb1, 0xfffefa9d, 0xfffdef89, 0xfffde373, 0xfffdd85c, 0xfffdcc48, 0xfffdc133, 0xfffeb41f, 0xfffea90a, 0xfffb9e00, 0xfff29201, 0xffe88601, 0xffde7b01, 0xffd46f01, 0xffca6401, 0xffc05701, 0xffb74c01, 0xffad4001, 0xffa33401, 0xff992801, 0xff8f1d01, 0xff8f1d01, 0xff851102, 0xff851814];
