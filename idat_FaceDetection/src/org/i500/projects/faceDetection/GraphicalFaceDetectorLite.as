/**
 * =============================================================================
 * GraphicalFaceDetectorLite
 * - org.i500.projects.faceDetection.GraphicalFaceDetectorLite
 * -----------------------------------------------------------------------------
...
package org.i500.projects.faceDetection 
{
	 ...
	 * - org.i500.projects.faceDetection.GraphicalFaceDetectorLite
	 */
	public class GraphicalFaceDetectorLite extends Sprite
	{
		//-----------------------------------------------------------
		// Consts
		//
		...
		private 	const 	CAMERA_FPS	 			:int 		= 4;
		 ...
		 * - org.i500.projects.faceDetection.GraphicalFaceDetectorLite
		 */		
		public function GraphicalFaceDetectorLite() 
		{
			super();
